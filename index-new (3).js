            ...
            if (paymentPattern.test(message.content.trim())) {
                ...
                setTimeout(async () => {
                    ...
                    if (probotMessage) {
                        ...
                        // إذا لم يتم العثور على رسالة ProBot، اطلب من المستخدم المحاولة مرة أخرى
                        await message.channel.send('⚠️ لم يتم العثور على تأكيد الدفع من ProBot. يرجى التأكد من إرسال الأمر بشكل صحيح والمحاولة مرة أخرى.');
                    }
                }, 3000); // زيادة الوقت قليلاً للتأكد من وصول رسالة ProBot
            }
            return;
        }
